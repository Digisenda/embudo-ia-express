      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Sistema automático de generación de clientes para tu negocio.
            </p>
          </div>
              ...
              <div className="flex space-x-4">
                ...
                {social.linkedin && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-gray-700 hover:bg-blue-700 rounded-full flex items-center justify-center transition-colors"
                    aria-label="LinkedIn"
                  >
                    <svg
                      className="w-5 h-5"
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-400">
          ...
          <p className="mt-2 text-sm">
            Powered by <span className="font-semibold">Embudo IA Express</span>
          </p>
        </div>
      </div>
    </footer>
